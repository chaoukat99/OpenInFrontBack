...
export function FeaturesSection({ type }: FeaturesSectionProps) {
  ...
  const consultantFeatures = [
    ...
    },
    {
      ...
      description: "Rejoignez une communauté active et participez à des événements pour élargir votre réseau.",
  ...
  return (
    <section id={type === "company" ? "features-company" : "features-consultant"} className="relative py-24 overflow-hidden">
      {/* Background elements */}
              ...
              >
                ...
                {feature.link ? (
                  ...
                  <Link to={feature.link} className="block h-full">
                    <GlassCard className="h-full hover:scale-[1.02] transition-transform duration-300 cursor-pointer" glow>
                      <div className="flex items-center gap-4 mb-4">
                        <div
                          className={`w-10 h-10 rounded-xl bg-gradient-to-br ${feature.color} flex-shrink-0 flex items-center justify-center shadow-lg`}
                        >
